...
- **S-06: użytkownik wycofuje asset z trackingu (exit z crypto); wycofana ilość jest usuwana z lokalizacji, realized P&L jest obliczany i zapisywany, portfolio odzwierciedla zmniejszoną pozycję.** — Archived 2026-06-17 → `context/archive/2026-06-17-withdraw-cash-out/`. Lesson: —.
- **S-10: widzi wykres wartości portfela i łącznego P&L w czasie (365 dni, dziennie)** — Archived 2026-06-27 → `context/archive/2026-06-27-portfolio-history-chart/`. Lesson: —.
